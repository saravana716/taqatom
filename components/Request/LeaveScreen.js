    ...
    <View style={styles.container}>
      <View style={styles.innerContainer}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerText}>{t(tokens.nav.leave)}</Text>
        </View>
        ...
        <View style={styles.centerContent}>
          {pieData && pieData.length > 0 ? (
            ...
            <View style={styles.noData}>
              <Text>{t(tokens.messages.noLeaveBalance)}</Text>
            </View>
          )}
        </View>
        ...
        {isLoading ? (
          ...
          <View style={styles.noLeave}>
            <Text style={styles.noLeaveText}>{t(tokens.messages.noLeave)}</Text>
          </View>
        ) : (
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalContainer}>
            <Text style={styles.modalTitle}>{t(tokens.actions.add)}</Text>
            ...
            <View style={styles.buttonRow}>
              ...
              >
                {isLoading ? (
                  ...
                  <Text style={styles.submitText}>{t(tokens.actions.add)}</Text>
                )}
              </TouchableOpacity>
            </View>
          </View>
